...
const Landing = forwardRef(({ ScrollToSection }, ref) => {
  ...
  return (
    <div ref={ref} className="landingImage flex justify-center mt-50 h-screen   mx-4 sm:mx-6 lg:mx-8 text-black">
      <div  className="w-full max-w-6xl h-full bg-theme lg:bg-transparent flex justify-center items-center lg:items-end" >
        ...
        <div  className="lg:hidden space-y-6 font-rubik-regular ">
          ...
          <div className="pt-4">
            {" "}
            <button onClick={()=>ScrollToSection("contact")} className="bg-mint text-white border text-sm px-5 py-4 border-yello rounded-[4px] hover:bg-yello hover:bg-opacity-20 transition ease-in duration-500">
